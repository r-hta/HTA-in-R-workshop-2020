...
# jpeg(filename = paste0("ce_plane_coumarin_vs_apixaban_", n_samples, ".jpg"))
...
# jpeg(filename = paste0("ce_plane_coumarin_vs_dabigatran_", n_samples, ".jpg"))

ceplane.plot(doac_bcea, comparison = 3, wtp = 20000, graph = "base")
...
# jpeg(filename = paste0("ceac_", n_samples, ".jpg"))

# mce.plot(doac_multi_ce, pos = c(1, 0.5), graph = c("base", "ggplot2"))
ceac.plot(doac_multi_ce)

# dev.off()

## Cost-effectiveness frontier curve
# jpeg(filename = paste0("ceaf_", n_samples, ".jpg"))
